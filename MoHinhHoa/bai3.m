...
% Last Modified by GUIDE v2.5 11-Oct-2024 22:40:19
...
N = str2num(N); %Chuyen gia tri chuoi kư tu sang dang so 
lamda = get(handles.edit2,'String');% Nh?n chu?i kư t? ? edit2 gán cho k2
lamda = str2num(lamda); %Chuy?n ??i t? chu?i kư t? sang d?ng s? 
T = get(handles.edit3,'String');% Nh?n chu?i kư t? ? edit3 gán cho t1
T = str2num(T); %Chuy?n ??i t? chu?i kư t? sang d?ng s?
