...
% Last Modified by GUIDE v2.5 04-Oct-2024 09:40:01

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @bai5_OpeningFcn, ...
                   'gui_OutputFcn',  @bai5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% UIWAIT makes bai5 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = bai5_OutputFcn(hObject, eventdata, handles) 
...
L = Q+Ppv*(lamda/miu);
set(handles.edit9,'String',L);

omega=d+Ppv/miu;
set(handles.edit11,'String',omega);
...
switch str{val}
 case 'Khao sat he thong' % Có bao nhiêu câu l?nh thì có b?y nhiêu case và nh? k?t thúc có câu l?nh end ? cu?i 
 clc;
disp('MO PHONG HE THONG HANG DOI - THM')
clc;
% Khai bao bien 
syms N Ttb lamda miu Pmk Ppv A Q L d omega
